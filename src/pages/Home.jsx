...
export default function Home() {
  ...
  <h1 className="text-3xl font-bold text-center w-full">Explore Movies & TV Series 🍿📺</h1>
  <button
    ...
    {isDarkMode ? "Light Mode" : "Dark Mode"}
      ...
      <div className="flex justify-center mb-8">
        <input
          ...
          className="p-3 w-full max-w-md rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-lg focus:outline-none focus:ring-2 focus:ring-indigo-600"
        />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {movies.length > 0 ? (
          ...
          <p className="col-span-full text-center text-xl font-semibold text-gray-600 dark:text-gray-300">
            No results found
          </p>
        )}
      </div>
