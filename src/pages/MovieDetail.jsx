      ...
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="ml-0 md:ml-6">
            ...
            <p className="text-lg text-gray-700 mb-2"><strong>Year:</strong> {movie.Year}</p>
            <p className="text-lg text-gray-700 mb-2"><strong>Genre:</strong> {movie.Genre}</p>
            <p className="text-lg text-gray-700 mb-2"><strong>IMDb Rating:</strong> {movie.imdbRating}</p>
            <p className="text-lg text-gray-700 mb-2"><strong>Director:</strong> {movie.Director}</p>
            <p className="text-lg text-gray-700 mb-2"><strong>Actors:</strong> {movie.Actors}</p>
            <p className="text-lg text-gray-700 mb-2"><strong>Production:</strong> {movie.Production}</p>
          </div>
        </div>
      </div>
    </div>
